...
## Use bcftools to extract the relevant information, handling potential errors
...
Okay, I understand! You want the raw text content of the entire README (including the code blocks) so you can paste it directly into GitHub's web interface, which will then render it with Markdown formatting.

Here is the complete raw text you can paste.
...
PGS files were downloaded from the Pan-UK Biobank phenotype manifest, accessible [here](https://docs.google.com/spreadsheets/d/1AeeADtT0U1AukliiNyiVzVRdLYPkTbruQSk38DeutU8/edit?gid=1450719288#gid=1450719288) . The URLs for these files are stored in a file named urls.txt.
